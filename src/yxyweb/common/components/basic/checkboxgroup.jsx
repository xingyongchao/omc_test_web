...
export default class CheckboxGroup extends Component {
  ...
  baseControl() {
    ...
    dataSource.forEach((item, index) => {
      ...
      options.push({ label: title, value: key ,disabled:this.state.disabled || item.disabled});
    ...
    return (
      <CheckGroup value={value} options={options} disabled={this.state.disabled} onChange={this.handleChange} />
    );
  }
  getControl() {
