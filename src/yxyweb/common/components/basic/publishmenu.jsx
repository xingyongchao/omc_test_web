...
export default class PublishMenu extends React.Component {
  ...
  canPublishToMobile = (filterId) => {
    ...
    eChartProxy.doProxy_Options("filterDesign/getSolutionList?terminalType=3", 'POST', { filterId }, callback, { terminalType: false });
  ...
  getPublishMenuCard() {
    ...
    if (self.state.bShowCard == true && _.isEmpty(params) == false) {
      ...
      content = <div className="publishMenu" key={"MenuKey_" + params.groupSchemaId ? params.groupSchemaId : "Null"} >
        <div className="publishMenu_count">
          ...
          {self.state.canPublishToMobile ? <div className="pc-mobile-show"   >
