...
import {Icon,Modal as Dialog} from 'antd';
import ActionButton from './ActionButton';
export default function confirm(config) {
    var props = _extends({ type:'confirm', iconType: 'question-circle' }, config);
    ...
    ReactDOM.render(React.createElement(
        Dialog,
        { className: classString, onCancel: close.bind(this, { triggerCancel: true }), visible: true, title: '', transitionName: null, footer: '', maskTransitionName: null, maskClosable: maskClosable, style: style, width: width },
        React.createElement(
            'div',
