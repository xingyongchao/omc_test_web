...
var LeftContent = function (_Component) {
  ...
  function LeftContent(props) {
    ...
    _this.onSelect = function (selectedKeys) {
      ...
      _this.props.addActions.select(selectedKeys[0]);
    };

    _this.onLoadData = function (treeNode) {
      _this.props.addActions.getEntityInfo(treeNode.props.eventKey);
    };
  ...
  _createClass(LeftContent, [{
    ...
    value: function render() {
      var _props$addMessage = this.props.addMessage,
          treeData = _props$addMessage.treeData,
          billNo = _props$addMessage.billNo;
