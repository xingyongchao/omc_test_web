...
function setOption(chartDisplayType, option, yySetting, data, skinConfig, panelType) {
    ...
    measure.forEach(function (itemMeasure, index) {
      ...
      data.forEach(function (itemData) {
        if (!!itemData[dimensionNameFileld] == true) {
          ...
          var tmpValue = _lodash2.default.get(itemData, itemMeasure.valueField, 0);
  ...
  var measure0 = _lodash2.default.filter(measure, function (o) {
    return o.yAxisIndex == 0;
  });
  var measure1 = _lodash2.default.filter(measure, function (o) {
  ...
  if (!!skinConfig && skinConfig.displaySkin) {
    ...
    _lodash2.default.set(option, "yAxis[0].nameTextStyle.color", skinConfig.displaySkin.textColor);
    _lodash2.default.set(option, "yAxis[1].nameTextStyle.color", skinConfig.displaySkin.textColor);

    _lodash2.default.set(option, "xAxis.axisLine.lineStyle.color", skinConfig.displaySkin.axisLineColor);
    _lodash2.default.set(option, "yAxis[0].axisLine.lineStyle.color", skinConfig.displaySkin.axisLineColor);
    _lodash2.default.set(option, "yAxis[1].axisLine.lineStyle.color", skinConfig.displaySkin.axisLineColor);

    _lodash2.default.set(option, "xAxis.splitLine.lineStyle.color", skinConfig.displaySkin.splitLineColor);
    _lodash2.default.set(option, "yAxis[0].splitLine.lineStyle.color", skinConfig.displaySkin.splitLineColor);
    _lodash2.default.set(option, "yAxis[1].splitLine.lineStyle.color", skinConfig.displaySkin.splitLineColor);

    _lodash2.default.set(option, "xAxis.axisLabel.textStyle.color", skinConfig.displaySkin.textColor);
    _lodash2.default.set(option, "yAxis[0].axisLabel.textStyle.color", skinConfig.displaySkin.textColor);
    _lodash2.default.set(option, "yAxis[1].axisLabel.textStyle.color", skinConfig.displaySkin.textColor);
  }
