...
function setOption(chartDisplayType, option, yySetting, data, skinConfig, panelType) {
  ...
  if (chartDisplayType == "panel") //如果在大屏展现，则需要特殊调整参数
    {
      if (panelType == 1) {
        ...
        _lodash2.default.set(option.series[1], "label.normal.show", false); //涟漪图不显示文字
        ...
        _lodash2.default.set(option, "geo.itemStyle.emphasis.areaColor", "#C6D9F9"); //选中子区域时的子区域颜色
      } else if (panelType == 3) {
        delete option.backgroundColor;
        ...
        _lodash2.default.set(option, "geo.itemStyle.emphasis.areaColor", "#98B9FA"); //选中子区域时的颜色
        _lodash2.default.set(option, "geo.label.emphasis.color", "#333333"); //选中子区域时的文字颜色
  ...
  if (!!skinConfig && skinConfig.displaySkin) {
    ...
    _lodash2.default.set(option, "visualMap.textStyle.color", skinConfig.displaySkin.textColor);
    ...
    _lodash2.default.set(option.series[0], "label.normal.textStyle.color", skinConfig.displaySkin.textColor);
    _lodash2.default.set(option.series[1], "label.normal.textStyle.color", skinConfig.displaySkin.textColor);

    _lodash2.default.set(option, "geo.label.emphasis.color", skinConfig.displaySkin.scatterChart_LabelEmphasisColor);
    _lodash2.default.set(option, "geo.itemStyle.emphasis.opacity", skinConfig.displaySkin.scatterChart_ItemStyleEmphasisOpacity);
  }
