...
var ReferModal = function (_React$Component) {
  ...
  _createClass(ReferModal, [{
    ...
    value: function componentDidMount() {
      ...
      this.props.model.on('toolbarHeightUpdate', function (height) {
    ...
    value: function render() {
      return _react2.default.createElement(Table, { tableMode: "refer", model: this.props.model, width: this.props.width, maxRowCount: this.props.maxRowCount, height: this.state.height });
    }
  }]);
