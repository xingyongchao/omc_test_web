...
var Container = function (_Component) {
  ...
  _createClass(Container, [{
    ...
    value: function calcWidth(width) {
      ...
      if (this.width < minWidth && env.INTERACTIVE_MODE !== 'touch') this.width = minWidth;
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var container = (0, _util.parseContainer)(meta, viewModel, this.width, height, index, this.hasTree);
