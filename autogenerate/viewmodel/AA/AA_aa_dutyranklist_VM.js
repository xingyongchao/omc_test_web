...
console.info('%c AA_aa_dutyranklist_VM js init', 'color:green');
cb.viewmodels.register('AA_aa_dutyranklist_VM', function(modelType) {
    ...
    model.prototype.init = function() {
        ...
        var fields = {
            ...
            'aa_dutyranklist': new cb.models.GridModel({
                "columns": {
                    "code": {
                        "cFieldName": "code",
                        "cItemName": "code",
                        "cCaption": "编码",
                        "cShowCaption": "编码",
                        "iBillEntityId": 1183686,
                        "iBillTplGroupId": 4924735,
                        "iTplId": 1181794,
                        "iMaxLength": 20,
                        "iFieldType": 1,
                        "bEnum": false,
                        ...
                        "cTplGroupName": "Table",
                        "bMain": true,
                        "cDataSourceName": "aa.position.DutyRank",
                        "cControlType": "Input",
                        "bVmExclude": 0,
                        "multiple": false,
                        "iOrder": 1,
    ...
    model.prototype.initData = function() {
        // if(cb.biz['AA'] && cb.biz['AA']['AA_aa_dutyranklist_VM_Extend']){
        //   console.info('%c AA_aa_dutyranklist_VM_Extend extendjs doAction', 'color:green');
        //   cb.biz['AA']['AA_aa_dutyranklist_VM_Extend'].doAction("init", this);
        // }else{
        //   console.log('%c no extend js' , 'font-size:22pt;color:red');
        // }
        var self = this;
        var extendFile = 'AA/AA_aa_dutyranklist_VM.Extend.js';
        cb.require([extendFile], function(extend) {
            ...
            console.info('%c extendVmName-->AA_aa_dutyranklist_VM_Extend', 'font-size:12pt;color:#860786')
            self.execute('extendReady', self);
        });
    };
